...
**Visual identity**:
- Section opener images: one per section at ANY page count (global Rule 11 / AIRF 2.0 auto-rule; page count never gates generation). Abstract, painterly, or 2D illustration style preferred over photorealism for most poetry collections. Images should suggest emotional register, not illustrate literal content.
